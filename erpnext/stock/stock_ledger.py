...
def get_stock_ledger_entries_fix(previous_sle, operator=None,
	...
	return frappe.db.sql("""
		...
		and is_cancelled = 0 and voucher_type="Sales Invoice"
		%(conditions)s
...
def get_previous_sle_fix(args, for_update=False):
	"""
	...
	sle = get_stock_ledger_entries_fix(args, "<", "desc", "limit 1", for_update=for_update)
